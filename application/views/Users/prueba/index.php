<!-- Slider -->
    ...
    <?php foreach ($consulta->result() as $table) { ?>
      <?php if($table->estado==1){
        $table->estado="Activo";
      }else{
        $table->estado="Inactivo";
      }?>
      <tr>
        <td><?php echo $table->idPrueba?></td>
        <td><?php echo $table->prueba?></td>
        <td><?php echo $table->estado?></td>
        <td><?php echo $table->pruebas_int?></td>
        <td><a href="<?php echo base_url(); ?>cPrueba/updateform/<?php echo $table->idPrueba ?>">Actualizar</a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>cPrueba/getid/<?php echo $table->idPrueba ?>">Ver</a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>cPrueba/delete/<?php echo $table->idPrueba ?>">Eliminar</a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>cPrueba/estado/<?php echo $table->idPrueba ?>/<?php echo $table->estado?>">Activar/Desactivar</a></td>
      </tr>
    <?php } ?>
  </table>
    </div>
...
<div>
	<a href="<?php echo base_url();?>cPrueba/CreateForm">Ingresar</a>
</div>-->